...
volume_frame = Frame(note1, width=300, height=300,bg='sky blue')
condition_frame = Frame(note1, width=300, height=300,bg='sky blue')
...
height2 = Entry(volume_frame, font=("Helvetica", 20),bg='blue')
height2.pack()
width = Label(
